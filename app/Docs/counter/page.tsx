...
`.trim();
  ...
  const buttonCodeExample1 = `
    <Counter targetNumber={256} textColor='#ffffff' variant="reverse"/>
    `.trim();

  const buttonCodeExample2 = `
    <Counter targetNumber={256} textColor='#ffffff' variant="casino"/>
    `.trim();

  const buttonCodeFunky = `
    <Counter targetNumber={256} textColor='#ffffff' variant="random"/>
    `.trim();
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 max-h-[350px] bg-white bg-opacity-10 rounded-xl border border-zinc-700 backdrop-filter backdrop-blur-lg overflow-auto">
            {showCodeStates[section] ? (
              ...
              <div className="flex flex-col items-center max-h-56 justify-center min-h-full space-y-4">
                <Counter targetNumber={256} textColor='#ffffff' variant={section === "example1" ? "reverse" : section === "example2" ? "casino" : section === "Random" ? "random" : undefined} />
              </div>
            )}
          </div>
        </div>
    ...
    <Layout>
      <div className="mx-auto px-14 py-12 space-y-8 max-w-4xl">
        <header className="space-y-3">
          <h1 className="text-[32px] font-semibold text-white">Counter</h1>
          <p className="text-lg text-zinc-300 font-medium">Displays a Counter or a component that looks like a button.</p>
        </header>

        {renderSection('preview', 'Preview', "Here's a preview of Counter components with a code.")}
        {renderSection('example1', 'Examples', "Example of the counter on reverse mode")}
        {renderSection('example2', 'Animated Example', "An example of counter on casino mode")}
        {renderSection('Random', 'Random Effect Example', "An example of counter on random mode")}
        <div className="space-y-4">
          ...
          <table className="w-full table-auto border-collapse border border-gray-300">
            ...
            <tbody>
              <tr className="">
                <td className="px-4 py-2 text-sm font-medium text-zinc-300 border border-gray-300"><Badge>targetNumber</Badge></td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">Number</td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">The number that you want to do count effect on</td>
              </tr>
              <tr className="">
                <td className="px-4 py-2 text-sm font-medium text-zinc-300 border border-gray-300"><Badge>variant</Badge></td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">String</td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">The type of counter&apos;s animation</td>
              </tr>
              <tr className="">
                <td className="px-4 py-2 text-sm font-medium text-zinc-300 border border-gray-300"><Badge>Speed</Badge></td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">String</td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">The speed of counting (Slow, Normal and fast)</td>
              </tr>
              <tr className="">
                <td className="px-4 py-2 text-sm font-medium text-zinc-300 border border-gray-300"><Badge>textSize</Badge></td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">String</td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">Just tailwind text&apos;s classes</td>
              </tr>
              <tr className="">
                <td className="px-4 py-2 text-sm font-medium text-zinc-300 border border-gray-300"><Badge>textColor</Badge></td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">String</td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">The color of the numbers</td>
              </tr>
              <tr className="">
                <td className="px-4 py-2 text-sm font-medium text-zinc-300 border border-gray-300"><Badge>fontWeight</Badge></td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">String</td>
                <td className="px-4 py-2 text-sm text-zinc-300 border border-gray-300">The font weight of the text</td>
              </tr>
